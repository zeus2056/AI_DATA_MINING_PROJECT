...
print("Sınıf başına kullanılabilecek maksimum örnek sayısı:", min_count)
...
demo = gr.Interface(
    ...
    description="Bu model Roberta kullanarak metni Pozitif, Negatif veya Nötr olarak sınıflandırır."
)
